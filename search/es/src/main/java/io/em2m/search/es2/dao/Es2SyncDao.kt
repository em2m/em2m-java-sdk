package io.em2m.search.es2.dao
...
import io.em2m.search.es.ResultConverter
...
class Es2SyncDao<T>(
    ...
    override fun upsertBatch(entities: List<T>): List<T> = this.upsertBatch(entities)
