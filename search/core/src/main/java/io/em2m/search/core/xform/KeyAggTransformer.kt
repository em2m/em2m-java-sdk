...
class KeyAggTransformer(val key: String) : AggTransformer() {
    ...
    override fun transformDateHistogramAgg(agg: DateHistogramAgg) = DateHistogramAgg(agg.field, agg.format, agg.interval, agg.offset, agg.timeZone, key, agg.missing, agg.extensions)
    ...
    override fun transformHistogramAgg(agg: HistogramAgg) = HistogramAgg(agg.field, agg.interval, agg.offset, key, agg.missing, agg.extensions)
